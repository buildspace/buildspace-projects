...
1. We need to know the url of the API call which is `https://api.openai.com/v1/completions`. You can find this by checking out the [docs for this API](https://beta.openai.com/docs/api-reference/completions)
