...
From here, we just need to update our `tokenURI` function to prepend `ipfs://`. Basically, Pixxiti likes when our image URI is structured like this: `ipfs://INSERT_YOUR_CID_HERE`. 
