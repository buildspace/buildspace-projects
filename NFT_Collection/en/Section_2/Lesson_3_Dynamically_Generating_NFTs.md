...
🚨Progress report.
------------------------
If you got one, send a screenshot in of your new dynamically generated NFT on OpenSea/Rarible in #progress :). Also -- if you haven't tweeted an image of your hilarious NFT collection yet now is the time to do so!! Remember to tag @_buildspace!!! We'll RT as many people as we can!
