...
Note: **You don't have to use replit to build + deploy your site. If you want to work locally on VSCode and use Vercel/Heroku/AWS to deploy and are confident in your web dev skills -- that's totally cool. [Here](https://github.com/zipeducation/buildspace-nft-course-starter) is a link to the base repo you can clone and work on locally.**
