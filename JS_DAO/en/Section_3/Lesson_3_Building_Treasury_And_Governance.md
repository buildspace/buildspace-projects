...
Finally, we have `minimumNumberOfTokensNeededToPropose: "0"` which allows anyone to actually create a proposal even if they hold zero governance token. Up to you what you want to set this at! Let's keep it at 0 for now. You may have to set a manual gas limit if you set this to a different value.
