...
```plaintext
ts-node ~/metaplex-foundation/metaplex/js/packages/cli/src/candy-machine-cli-v2.ts update_candy_machine -e devnet  -k ~/.config/solana/devnet.json -cp config.json
```
