...
Boom! If you see some stuff in your terminal about a contract being deployed -- this means your local environment is set up **and** you also ran/deployed a smart contract to a local blockchain.
